 ...
 * Side effects: May mutate server state.
 */
export const agentInvokeAToolOnAnMcpServer = <ThrowOnError extends boolean = false>(options: Options<AgentInvokeAToolOnAnMcpServerData, ThrowOnError>) => (options.client ?? client).post<AgentInvokeAToolOnAnMcpServerResponses, AgentInvokeAToolOnAnMcpServerErrors, ThrowOnError>({
